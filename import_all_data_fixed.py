#!/usr/bin/env python3
"""
Fixed import script that properly handles all FreeLaw bulk data
...
def main():
    """Import all FreeLaw data types"""
    
    print("🏛️  FREELAW BULK DATA IMPORTER - ALL TYPES")
    print("=" * 60)
    ...
    imports = [
        ("courts-2024-12-31.csv.bz2", "courts", None, None, 1000),  # Skip courts - already imported
        ("dockets-2024-12-31.csv.bz2", "dockets", parse_docket_row, storage.save_docket, 1000),
        ("opinion-clusters-2024-12-31.csv.bz2", "opinion_clusters", parse_opinion_cluster_row, storage.save_opinion_cluster, 500),
    ]
...
if __name__ == "__main__":
    success = main()
    if success:
        print("\n🎉 All data types imported successfully!")
    else:
        print("\n❌ Import failed!")